...
export class CoachBoard extends LitElement {
  ...
  #saveSvg() {
    ...
    meta.setAttribute('data-version', '1.5.2');
    ...
    return html`
      ${this._viewMode === 'readonly' ? html`
        <div class="toolbar-area readonly-branding">
          <a href="/" class="branding-link" title="Open CoachingBoard">
            <svg class="branding-icon" viewBox="0 0 1017 1362" fill="currentColor"><path d="M714.5 135.188V119.251C714.5 105.439 703.312 94.2507 689.5 94.2507H626.688C615.188 40.4387 567.25 0 510.062 0H506.375C449.187 0 401.249 40.4373 389.749 94.2507H327C313.188 94.2507 302 105.438 302 119.251V135.188H136.747C61.372 135.188 0 196.625 0 272.188V1224.93C0 1300.31 61.3747 1361.68 136.747 1361.68H879.76C955.135 1361.68 1016.51 1300.31 1016.51 1224.93V272.188C1016.51 196.625 955.132 135.188 879.76 135.188H714.5ZM879.073 272.748V1224.05H137.446V272.748H879.073ZM352.006 144.248H412.131C425.943 144.248 437.131 133.061 437.131 119.248C437.131 81.06 468.194 49.9973 506.382 49.9973H510.07C548.258 49.9973 579.32 81.06 579.32 119.248C579.32 133.06 590.508 144.248 604.32 144.248H664.508V222.748H352.015L352.006 144.248ZM966.5 1224.94C966.5 1272.75 927.562 1311.69 879.75 1311.69L136.737 1311.63C88.9248 1311.63 49.9875 1272.69 49.9875 1224.88V272.186C49.9875 224.186 88.9248 185.186 136.737 185.186H301.99V222.811H112.417C98.6048 222.811 87.4168 233.998 87.4168 247.811V1249.12C87.4168 1262.93 98.6043 1274.12 112.417 1274.12H904.043C917.855 1274.12 929.043 1262.93 929.043 1249.12V247.744C929.043 233.932 917.856 222.744 904.043 222.744H714.47V185.119H879.724C927.536 185.119 966.473 224.119 966.473 272.119L966.5 1224.94Z"/><path d="M226.665 625.217C231.571 630.123 237.987 632.576 244.466 632.576C250.881 632.576 257.36 630.123 262.266 625.217L319.125 568.294L376.048 625.217C380.954 630.123 387.369 632.576 393.848 632.576C400.264 632.576 406.742 630.123 411.649 625.217C421.461 615.405 421.461 599.492 411.649 589.617L354.726 532.695L411.649 475.773C421.461 465.961 421.461 450.047 411.649 440.173C401.837 430.361 385.924 430.361 376.049 440.173L319.127 497.158L262.205 440.236C252.393 430.424 236.479 430.424 226.605 440.236C216.793 450.048 216.793 465.961 226.605 475.836L283.527 532.758L226.605 589.68C216.793 599.429 216.793 615.342 226.668 625.217H226.665Z"/><path d="M576.632 979.005C576.632 1040.1 626.36 1089.84 687.438 1089.84C748.515 1089.84 798.243 1040.1 798.243 979.005C798.243 917.91 748.515 868.231 687.438 868.231C626.36 868.168 576.632 917.91 576.632 979.005ZM748.082 979.005C748.082 1012.44 720.866 1039.66 687.443 1039.66C654.02 1039.66 626.804 1012.44 626.804 979.005C626.804 945.572 654.02 918.412 687.443 918.412C720.866 918.349 748.082 945.572 748.082 979.005Z"/><path d="M507.29 764.105L429.759 794.018C363.896 819.416 319.674 883.884 319.674 954.372V1064.81C319.674 1078.67 330.902 1089.89 344.765 1089.89C358.627 1089.89 369.855 1078.67 369.855 1064.81V954.372C369.855 904.455 401.156 858.799 447.824 840.801L525.355 810.889C591.155 785.491 635.377 721.086 635.377 650.535V518.59L666.991 550.196C671.884 555.088 678.282 557.533 684.743 557.533C691.141 557.533 697.602 555.088 702.495 550.196C712.28 540.413 712.28 524.547 702.495 514.702L627.976 440.2C618.19 430.417 602.32 430.417 592.473 440.2L517.953 514.702C508.168 524.485 508.168 540.414 517.953 550.196C522.846 555.088 529.244 557.533 535.706 557.533C542.104 557.533 548.564 555.088 553.458 550.196L585.197 518.464V650.597C585.197 700.454 553.895 746.107 507.29 764.105Z"/></svg>
      ...
      <dialog id="about-dialog">
        ...
        <div class="dialog-body about-body">
          ...
          <div class="about-meta">Version 1.5.2-beta</div>
          ...
          ${this._myBoards.length ? html`
            <ul class="boards-list">
              ${this._myBoards.filter(b => b.name !== 'Untitled Board').map(b => html`
                <li>
                  <svg class="board-icon" viewBox="0 0 1200 1200" width="20" height="20" aria-hidden="true" fill="currentColor" @click="${() => this.#handleOpenBoard(b.id)}">
